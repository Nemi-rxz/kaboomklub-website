              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {playlists.map((pl) => (
                  <div key={pl.id} className="flex flex-col border border-[#17120c]/12 bg-[#17120c] text-[#f7f3ea]">
                    ...
                    <div className="relative flex h-48 items-center justify-center overflow-hidden bg-gradient-to-br from-[#1db954]/20 to-[#17120c] p-8">
                      <PublicImage src={pl.image} alt={pl.title} fill sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" className="object-cover opacity-80" />
                      <div className="absolute inset-0 bg-[#17120c]/35" />
